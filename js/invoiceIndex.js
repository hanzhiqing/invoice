...
function setAppData(result) {
    if (result) {
        // 获取动态manager服务器地址
        if (result.managerServer == null) {
            alert('manager服务器地址为空，请检查!');
            return false;
        }

        BASE_URL = result.managerServer;
        APP_DATA = {
            elionUserId: result.elionUserId,
            //elionUserId: '-5495603660517455920'
        };
    }
